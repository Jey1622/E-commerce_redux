  ...
  return (
    ...
    <div className="bg-white mt-2  px-4 md:px-16 lg:px-24 ">
      <div className="container mx-auto py-4 flex flex-col md:flex-row space-x-2">
        ...
        <div className="w-full md:9/12 mt-8 md:mt-0 h-96 relative">
          ...
          <div className="absolute top-16 left-8 ">
            ...
            <button className="bg-red-600 px-8 py-1.5 text-white mt-4 hover:bg-red-700 teansform transition-transform duration-300 hover:scale-105">SHOP NOW</button>
          </div>
        </div>
      </div>
      <InfoSection/>
      ...
      <div className="container mx-auto py-12">
        <h2 className="text-2x1 font-bold mb-6 text-center">TOp Productes</h2>
